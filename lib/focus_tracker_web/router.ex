defmodule FocusTrackerWeb.Router do
  ...
  import FocusTrackerWeb.UserAuth
  ...
  if Application.compile_env(:focus_tracker, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: FocusTrackerWeb.Telemetry
  ...
  scope "/", FocusTrackerWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{FocusTrackerWeb.UserAuth, :require_authenticated}] do
  ...
  scope "/", FocusTrackerWeb do
    ...
    live_session :current_user,
      on_mount: [{FocusTrackerWeb.UserAuth, :mount_current_scope}] do
